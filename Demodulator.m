...
classdef Demodulator < handle
    ...
    methods
        ...
        function analyzeMessage(obj, decodedSymbols, outInterface)
            ...
            outInterface.results.SV_ID = num2str(SV_ID);
            outInterface.results.message_ID = num2str(M_ID);    
            outInterface.results.message_Body = num2str(M_body);         
            outInterface.results.CRC = num2str(CRCMessage);                      
